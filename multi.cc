...
void doIt(double lifetimens, double frequency, double power){
  ...
  radio->makeOutputFile("../outputfiles/multiscat_"+frequencyStr+"GHz_"+powerStr+"W_"+lifetimeStr+"ns.root");
  ...
  radio->setRxSampleRate(1.);//receiver sample rate
//  radio->setRxSampleRate(0.5);//receiver sample rate
